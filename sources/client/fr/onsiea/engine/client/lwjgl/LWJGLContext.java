...
{
	// Verification des probl�mes li�s � la LWJGL/GLFW ou OpenGL (performance, nullpointer, fonction facultative) peut �tre
	// d�sactiver pour la version release mais doit �tre conserver pour la version de developpement
	// Param�tre :
