...
public class ButtonNode
{
	...
	private @Getter @Setter ButtonNode	next;

	public ButtonNode(final Button buttonIn)
	{
		this.button = buttonIn;
	}

	public ButtonNode(final Button buttonIn, final ButtonNode nextIn)
	{
		this.button	= buttonIn;
		this.next	= nextIn;
	}

	public final boolean isJustTriggered()
	{
		if (!this.button.isJustPressed())
		{
			return false;
		}
		return this.next == null || this.next.isJustTriggered();
	}
	...
	public final boolean isTriggered()
	{
		...
		return this.next == null || this.next.isTriggered();
	}
	...
	public boolean isReleased()
	{
		...
		return this.next == null ? false : this.next.isReleased();
	}
}