...
import fr.onsiea.engine.client.input.TimedAction;
 ...
 *
 */
public abstract class BaseButtonAction implements IButtonAction
{
	private @Getter @Delegate final TimedAction action;

	public BaseButtonAction()
	{
		this.action = new TimedAction();
	}

	@Override
	public boolean isJustPressed()
	{
		return EnumSubActionType.JUST_PRESSED.equals(this.action.subType());
	}

	@Override
	public boolean isReleased()
	{
		return this.action.subType().isReleased();
	}

	@Override
	public final EnumActionType type()
	{
		return this.action.subType().type();
	}

	@Override
	public final EnumSubActionType subType()
	{
		return this.action.subType();
	}
}