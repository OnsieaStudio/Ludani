...
*	@author Seynax
*/
package fr.onsiea.engine.client.graphics.glfw.callback;
...
{
	@Override
	public void invoke(int errorIn, long descriptionIn)
	{
		if (errorIn == GLFW.GLFW_NO_ERROR)
		{
			return;
		}

		System.err.println("[ERROR]-GLFW " + GLFWUtils.errorString(errorIn) + " [" + errorIn + "] : "
				+ GLFWErrorCallback.getDescription(descriptionIn) + " [" + descriptionIn + "] ");
	}
}