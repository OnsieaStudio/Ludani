...
public class GLMeshElementsComponent implements IGLMeshComponent
{
	private final EnumGLMeshComponentType	type;
	private final Elements					elements;

	public GLMeshElementsComponent(Elements elementsIn)
	{
		this.type		= EnumGLMeshComponentType.ELEMENTS;
