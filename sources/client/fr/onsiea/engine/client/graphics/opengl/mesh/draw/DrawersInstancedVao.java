 ...
 *
 */
public class DrawersInstancedVao implements IMeshDrawFunction
{
	...
	public DrawersInstancedVao(Elements elementsIn, Vao vaoIn, int attribsIn, int vertexCountIn, int primCountIn)
	{
		this.vao			= vaoIn;
	...
	{
		this.vao.drawInstanced(this.vertexCount, this.primCount);
