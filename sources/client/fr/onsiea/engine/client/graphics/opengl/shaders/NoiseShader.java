...
public class NoiseShader extends GLShaderProgram implements IView, IProjection
{
	 ...
	 * @throws Exception
	 */
	public NoiseShader() throws Exception
	{
		super("noise", "resources/shaders/vertexNoise.vs", "resources/shaders/fragmentNoise.fs", "position");
