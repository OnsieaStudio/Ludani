...
public class Cube
{
	public float[] vertices(int x, int y, int z)
	{
		...
		//  v2------v3
		return new float[]
		{ -1.0f + x, -1.0f + y, -1.0f + z, // triangle 1 : begin
				-1.0f + x, -1.0f + y, 1.0f + z, -1.0f + x, 1.0f + y, 1.0f + z, // triangle 1 : end
				1.0f + x, 1.0f + y, -1.0f + z, // triangle 2 : begin
				-1.0f + x, -1.0f + y, -1.0f + z, -1.0f + x, 1.0f + y, -1.0f + z, // triangle 2 : end
				1.0f + x, -1.0f + y, 1.0f + z, -1.0f + x, -1.0f + y, -1.0f + z, 1.0f + x, -1.0f + y, -1.0f + z,
				1.0f + x, 1.0f + y, -1.0f + z, 1.0f + x, -1.0f + y, -1.0f + z, -1.0f + x, -1.0f + y, -1.0f + z,
				-1.0f + x, -1.0f + y, -1.0f + z, -1.0f + x, 1.0f + y, 1.0f + z, -1.0f + x, 1.0f + y, -1.0f + z,
				1.0f + x, -1.0f + y, 1.0f + z, -1.0f + x, -1.0f + y, 1.0f + z, -1.0f + x, -1.0f + y, -1.0f + z,
				-1.0f + x, 1.0f + y, 1.0f + z, -1.0f + x, -1.0f + y, 1.0f + z, 1.0f + x, -1.0f + y, 1.0f + z, 1.0f + x,
				1.0f + y, 1.0f + z, 1.0f + x, -1.0f + y, -1.0f + z, 1.0f + x, 1.0f + y, -1.0f + z, 1.0f + x, -1.0f + y,
				-1.0f + z, 1.0f + x, 1.0f + y, 1.0f + z, 1.0f + x, -1.0f + y, 1.0f + z, 1.0f + x, 1.0f + y, 1.0f + z,
				1.0f + x, 1.0f + y, -1.0f + z, -1.0f + x, 1.0f + y, -1.0f + z, 1.0f + x, 1.0f + y, 1.0f + z, -1.0f + x,
				1.0f + y, -1.0f + z, -1.0f + x, 1.0f + y, 1.0f + z, 1.0f + x, 1.0f + y, 1.0f + z, -1.0f + x, 1.0f + y,
				1.0f + z, 1.0f + x, -1.0f + y, 1.0f + z };
	}
	...
	/**
		...
		public final static Triangle3f	FRONT_LOW			= new Triangle3f(Cube.V000, Cube.V100,
				Cube.V110);
		public final static Triangle3f	FRONT_HIGH			= new Triangle3f(Cube.V110, Cube.V010,
				Cube.V000);

		public final static Triangle3f	BACK_LOW			= new Triangle3f(Cube.V001, Cube.V101,
				Cube.V111);
		public final static Triangle3f	BACK_HIGH			= new Triangle3f(Cube.V111, Cube.V011,
				Cube.V001);

		public final static Triangle3f	RIGHT_LOW			= new Triangle3f(Cube.V100, Cube.V101,
				Cube.V111);
		public final static Triangle3f	RIGHT_HIGH			= new Triangle3f(Cube.V111, Cube.V110,
				Cube.V100);

		public final static Triangle3f	LEFT_LOW			= new Triangle3f(Cube.V000, Cube.V001,
				Cube.V011);
		public final static Triangle3f	LEFT_HIGH			= new Triangle3f(Cube.V011, Cube.V010,
				Cube.V000);

		public final static Triangle3f	BOTTOM_LOW			= new Triangle3f(Cube.V000, Cube.V100,
				Cube.V101);
		public final static Triangle3f	BOTTOM_HIGH			= new Triangle3f(Cube.V101, Cube.V001,
				Cube.V000);

		public final static Triangle3f	TOP_LOW				= new Triangle3f(Cube.V010, Cube.V110,
				Cube.V111);
		public final static Triangle3f	TOP_HIGH			= new Triangle3f(Cube.V111, Cube.V011,
				Cube.V010);
