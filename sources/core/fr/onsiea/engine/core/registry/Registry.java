...
*	@author Seynax
*/
package fr.onsiea.engine.core.registry;
...
{
	private Map<String, T> registries;
	...
	public Registry<T> add(String nameIn, T valueIn)
	{
		this.registries().put(nameIn, valueIn);
	...
	{
		return this.registries().get(nameIn);
	}

	public void remove(String nameIn)
	{
		this.registries().remove(nameIn);
	}
}