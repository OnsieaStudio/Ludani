 ...
 *
 */
public class NormalizablefWithListener extends NormalizableWithListener<Float>
{
	/**
	 ...
	 * @param maxListenerIn
	 */
	public NormalizablefWithListener(final IListener<Float> valueListenerIn, final ISetter<Float> valueSetterIn,
			final IListener<Float> maxListenerIn)
	{
		super(valueListenerIn, valueSetterIn, maxListenerIn);
	}

	public NormalizablefWithListener(final IListener<Float> valueListenerIn, final ISetter<Float> valueSetterIn,
			final NormalizablefWithListener normalizableIn)
	{
		super(valueListenerIn, valueSetterIn, normalizableIn);
	}

	@Override
	public NormalizablefWithListener invert()
	{
